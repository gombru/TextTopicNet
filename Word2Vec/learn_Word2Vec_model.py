...
print '  '+sys.argv[0]
print '  Learns Word2Vec topic model with '+str(NUM_TOPICS)+' topics from corpora on '+train_dict_path
print '  (...)'
...
# Learn the Word2Vec model
print 'Learning the Word2Vec model ...',
sys.stdout.flush()
word2vecmodel = models.Word2Vec(texts, size = NUM_TOPICS, workers=8, iter=25, window=8)
word2vecmodel.save('word2vecmodel'+str(NUM_TOPICS)+'.word2vec')
print ' Done!'
...
print 'Learning the Word2Vec model ...',
sys.stdout.flush()
word2vecmodel = models.Word2Vec(texts, size = 300, workers=8, iter=25, window=8)
word2vecmodel.save('word2vecmodel'+str(300)+'.word2vec')
print ' Done!'
